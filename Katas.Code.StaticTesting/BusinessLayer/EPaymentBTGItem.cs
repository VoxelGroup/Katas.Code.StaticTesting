...
{
    /// <summary>EPaymentBTGItem</summary>

    [DataContract(Namespace = "http://www.voxelgroup.net/Services/Models", Name = "EPaymentBTGItem")]
    public class EPaymentBTGItem : EPaymentItem
    {
        /// <summary>
        /// Ctor
        /// </summary>
        /// <param name="epayment"></param>
        public EPaymentBTGItem(EPaymentItem epayment) : base(
