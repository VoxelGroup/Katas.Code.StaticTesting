...
{   
    ...
    public class EPaymentSyncBLL2 
    {
        public void AddEPayment(DatabaseTransaction trans, EPaymentItem epayment)
        {
            if (epayment == null)
            ...
            KeyValuePair<long, ServiceSector>? clientSenderIdAndSectorId = GetClientSenderIdAndSectorId(trans, epayment);
            ...
            KeyValuePair<long, ServiceSector>? clientPayerIdAndSectorId = GetClientPayerIdAndSectorId(trans, epayment);
        ...
        protected virtual KeyValuePair<long, ServiceSector>? GetClientPayerIdAndSectorId(DatabaseTransaction trans, EPaymentItem epayment)
        {
            return UsersBLL.GetClientIdAndSectorIdFromPaymentReference(trans, epayment.ClientPayerReference);
        }

        protected virtual KeyValuePair<long, ServiceSector>? GetClientSenderIdAndSectorId(DatabaseTransaction trans, EPaymentItem epayment)
        {

            return UsersBLL.GetClientIdAndSectorIdFromPaymentReference(trans, epayment.ClientSenderReference);

        }

        protected virtual void SentNotificationErrorInPayment(DatabaseTransaction trans, long supplierId, long clientSenderId, string reference, string epayInvoice, string supplierName, string v1, string v2, string emailList)
        {
            throw new NotImplementedException();
        }

        protected virtual void SentNotificationNewEPaymentReceived(DatabaseTransaction trans, ServiceSector sectorClientSender, long value1, long clientSenderId, UserRole supplierRoleId, long supplierId, string supplierName, MailUrn email, FormOfPayment fop, List<EPaymentBookingItem> bookings, List<EPaymentInvoiceItem> invoices, long value2)
        {
            throw new NotImplementedException();
        }

        protected virtual EPaymentItem GetEPayment(DatabaseTransaction trans, string reference)
        {
            throw new NotImplementedException();
        }

        protected virtual void SendSettledPaymentNotification(DatabaseTransaction trans, long clientSenderId, List<EPaymentInvoiceItem> invoices, long? v, string supplierName, MailUrn email, EPaymentStatus status1, ServiceSector sectorClientSender, object status2)
        {
            throw new NotImplementedException();
        }

        protected virtual FormOfPayment GetFOPFromEpayment(EPaymentItem epayment)
        {
            throw new NotImplementedException();
        }
    }
    ...
    {
        static EPaymentSyncBLL2 epaym;
        static EPaymentsSyncBLL()
        {
            EPaymentSyncBLL2 epaym = new EPaymentSyncBLL2();
        }
        /// <summary>
        /// AddEPayment
        /// </summary>
        ...
        {
            epaym.AddEPayment(trans, epayment);
        }        
